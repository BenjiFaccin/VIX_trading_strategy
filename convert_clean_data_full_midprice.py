...
cleaned_data_path = os.path.join(base_path, "Historical_EoD_VIX_Cleaned_Data_2010_to_2023")
...
for folder_name, subfolders, file_names in os.walk(eod_data_path):  # Traverse through all subfolders
    for file_name in file_names:
        if file_name.endswith(".xlsx"):  # Only process .xlsx files
            ...
            # Remove rows where P_VOLUME < 10
            vix_eod_df = vix_eod_df[vix_eod_df["P_VOLUME"] >= 10]
