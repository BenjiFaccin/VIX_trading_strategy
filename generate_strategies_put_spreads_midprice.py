...
# Define directories
base_dir = "C:/Users/33698/Desktop/VIX_Trading_Strategy/Historical_EoD_VIX_Cleaned_Data_2010_to_2023"
output_dir = "C:/Users/33698/Desktop/VIX_Trading_Strategy/VIX_put_spread_strategies_maturity"
            ...
            if file.endswith(".xlsx"):
                ...
                try:
                    ...
                    for dte in unique_dtes:
                        ...
                        atm_put_mid = (atm_put.iloc[0]['P_BID'] + atm_put.iloc[0]['P_ASK']) / 2
                        sell_put_mid = (sell_put.iloc[0]['P_BID'] + sell_put.iloc[0]['P_ASK']) / 2
